...
运行效果截图如下（默认设置 1 分钟请求同一个接口 10 次，返回 429 状态码）：

![An image](/images/RD/express-limit-1.png)

**Golang 语言类似相关的中间库/插件：**

1. https://github.com/juju/ratelimit
2. https://github.com/envoyproxy/ratelimit
3. https://github.com/uber-go/ratelimit
...
![An image](/images/RD/express-limit-2.png)
