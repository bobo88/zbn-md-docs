# NativeVUE 开发 App 实践文档

本地效果截图如下：

![An image](/images/loT/nativevue-app-1.png)

## 一、配置环境（先决条件）

要使用 NativeScript-Vue，您的系统需要设置为能够编译和运行原生应用程序。

详细指南请参阅 NativeScript 文档：[https://docs.nativescript.org/setup/](https://docs.nativescript.org/setup/)
...
![An image](/images/loT/nativevue-app-2.png)

### 2. Eclipse Temurin 截图

![An image](/images/loT/nativevue-app-3.png)
...
![An image](/images/loT/nativevue-app-4.png)

**安装失败后，验证 `ns doctor android`**

![An image](/images/loT/nativevue-app-5.png)

**安装成功后**

![An image](/images/loT/nativevue-app-6.png)

JAVA_HOME 环境变量配置有问题，多了一个 `\bin`

![An image](/images/loT/nativevue-app-7.png)

**去掉 `\bin` 后，验证 `ns doctor android`， 一切正常。**

![An image](/images/loT/nativevue-app-8.png)

**环境变量配置截图**

![An image](/images/loT/nativevue-app-9.png)

### 4. 问题修复：系统映像缺失

![An image](/images/loT/nativevue-app-10.png)

![An image](/images/loT/nativevue-app-11.png)

**解决方案**

网络问题：电脑不要开 VPN 代理，即可正常下载。

![An image](/images/loT/nativevue-app-12.png)
...
![An image](/images/loT/nativevue-app-13.png)
...
![An image](/images/loT/nativevue-app-14.png)

![An image](/images/loT/nativevue-app-15.png)

![An image](/images/loT/nativevue-app-16.png)
...
![An image](/images/loT/nativevue-app-17.png)

![An image](/images/loT/nativevue-app-18.png)

![An image](/images/loT/nativevue-app-19.png)

![An image](/images/loT/nativevue-app-20.png)
...
**如果还是报错，则配置 Gradle 强制使用国内镜像（全局配置）**
...
- [https://nativescript-vue.org/docs/getting-started/installation](https://nativescript-vue.org/docs/getting-started/installation)
