# Apifox 前后端联调实践 V1.0.0

**作者：** 袁波  
**时间：** 2024.12.26

在前后端开发中，**API 联调** 是确保前端与后端成功通信并协同工作的关键环节。以下是一个典型的 API 联调流程，以及如何在 Vue 3 项目中实现和优化。

**代码仓库地址：** `git@gl.szzbn.cn:FE/admin-vue3.git`

整体流程可以参考本文档第 5 部分【流程实践截图】。
...
- 使用 API 文档工具（如 Swagger、Postman、Apifox）确保需求一致。**首选：Apifox**（支持团队协作、Mock 数据、自动化测试等）
...
![An image](/images/FE/apifox-1.png)

### 5.2 编写 API 接口，并查看 Mock 请求地址。

![An image](/images/FE/apifox-2.png)

### 5.3 配置本地跨域请求。

![An image](/images/FE/apifox-3.png)

### 5.4 编写前端 API 接口对接逻辑。

![An image](/images/FE/apifox-4.png)

### 5.5 调用 API 接口。

![An image](/images/FE/apifox-5.png)

### 5.6 查看请求和响应数据。

![An image](/images/FE/apifox-6.png)

![An image](/images/FE/apifox-7.png)
