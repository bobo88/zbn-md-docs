...
**一句话概况：** PWA 就是把你的网页做成 App 效果，且具有静态缓存功能。
...
- **更改图片大小尺寸工具：** https://www.resizepixel.com/

**步骤：** 分享按钮 -- 添加到主屏幕 -- 自定义 App 名称 -- 手机主界面查看效果。

**官网效果截图：**

![An image](/images/FE/pwa-1.png)

![An image](/images/FE/pwa-2.png)

![An image](/images/FE/pwa-3.png)

![An image](/images/FE/pwa-4.png)

![An image](/images/FE/pwa-5.png)
...
pwa: {
  ...
  manifest: {
    ...
    // start_url: ".",
    display: "standalone", // 或者 'fullscreen', 'minimal-ui'
    background_color: "#ffffff",
    theme_color: "#4DBA87",
    icons: [
      {
  ...
  // Service Worker 和缓存配置
  workbox: {
    maximumFileSizeToCacheInBytes: 8 * 1024 * 1024, // 允许最大文件大小为 8 MiB
    // Workbox 选项 (可选)
    runtimeCaching: [
      {
